...
const file_proto_authenticator_authenticator_proto_rawDesc = "" +
	...
	"\thttp_only\x18\a \x01(\bR\bhttpOnly2\xeb\x03\n" +
	"\rAuthenticator\x12q\n" +
	"\n" +
	...
	"\x11InitFacebookLogin\x12'.authenticator.InitFacebookLoginRequest\x1a(.authenticator.InitFacebookLoginResponse\"#\x82\xd3\xe4\x93\x02\x1d\x12\x1b/api/v1/login/facebook/init\x12w\n" +
	"\x16HandleFacebookCallback\x12,.authenticator.HandleFacebookCallbackRequest\x1a-.authenticator.HandleFacebookCallbackResponse\"\x00B\x17Z\x15authenticator/api;apib\x06proto3"
