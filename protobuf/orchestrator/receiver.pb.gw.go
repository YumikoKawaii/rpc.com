...
func request_Receiver_SendMessage_0(ctx context.Context, marshaler runtime.Marshaler, client ReceiverClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
...
func local_request_Receiver_SendMessage_0(ctx context.Context, marshaler runtime.Marshaler, server ReceiverServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq SendMessageRequest
		metadata runtime.ServerMetadata
	)
...
func RegisterReceiverHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ReceiverServer) error {
	mux.Handle(http.MethodPost, pattern_Receiver_SendMessage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/orchestrator.Receiver/SendMessage", runtime.WithHTTPPathPattern("/api/v1/messages"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Receiver_SendMessage_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Receiver_SendMessage_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
// "ReceiverClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterReceiverHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReceiverClient) error {
	mux.Handle(http.MethodPost, pattern_Receiver_SendMessage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/orchestrator.Receiver/SendMessage", runtime.WithHTTPPathPattern("/api/v1/messages"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Receiver_SendMessage_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Receiver_SendMessage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "messages"}, ""))
)

var (
	forward_Receiver_SendMessage_0 = runtime.ForwardResponseMessage
)
